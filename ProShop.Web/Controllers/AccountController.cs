...
namespace ProShop.Web.Controllers
{
    public class AccountController : Controller
    {
        ...
        [HttpPost]
        [CaptchaValidation("CaptchaCode", "RegiterCaptcha", "Mã xác nhận không đúng!")]
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if(adminUser != null) {
               await _userManager.AddToRolesAsync(adminUser.Id, new string[] { "User" });
                    ...
                    MainHelper.SendMail(adminUser.Email, "Đăng ký thành công", content);
        ...
        {
            IAuthenticationManager authencationManager = HttpContext.GetOwinContext().Authentication;
            authencationManager.SignOut();
            return RedirectToAction("Index", "Home");
        }
    }
}